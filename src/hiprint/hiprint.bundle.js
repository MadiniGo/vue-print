...
"use strict";
 ...
 function getBracketContent (str) {
  ...
  match = match ? match.replace("deg","") : null;
  return match;
}
...
for(let i = 0.75; i <= 60; i = i + 0.25){
  new_select_options += `<option value="${i}" >${i}pt</option>\n`
}
var languages = {}
    ...
    BasePrintElement = function () {
      ...
      return BasePrintElement.prototype.getConfigOptionsByName = function (t) {
        ...
        var e = $(".toplineOfPosition.id" + this.id),
          ...
          //#####假如是旋转后的则先关闭参考线
        var designTarget = this.designTarget && this.designTarget[0]? this.designTarget[0] : null;
        if(designTarget && getBracketContent(designTarget.style.transform)){
          return;
        }
        ...
        t.attr("tabindex", "1"), t.keydown(function (r) {
          ...
          function rotateCanMove(target){
            if(target && target.style && getBracketContent(target.style.transform)){
              return false
            }
            return true
          }
      ...
      return t.prototype.createTarget = function (t, o) {
        ...
        if (t && t.length && this.target) {
          ...
          if (('block' == t.find('.resize-panel').css('display') || t[0].className.includes('table')) && this.el == t) {
            var v = this.getValue();
            if(t[0] && getBracketContent(t[0].style.transform)){
              var targetH = parseFloat(t[0].style.height);
              var computedLeft = v.left + targetH
              return t.css("left", computedLeft + "pt").css("top", v.top + "pt");
            }
    ...
    U2 = function(){
      ...
      return t.prototype.css = function (t, e) {
        if (t && t.length) {
          ...
          if (e) return n.css("transform-origin", e), n.css("-ms-transform-origin",  e ), n.css("-moz-transform-origin", e ), n.css("-webkit-transform-origin",e ), n.css("-o-transform-origin",   e ),"transform-origin:" + e;
          n.length && (n[0].style.transformOrigin = "");
        }
        return null;
      }, t.prototype.createTarget = function () {
        return this.target = $(`<div class="hiprint-option-item">\n      
            <div class="hiprint-option-item-label">\n        ${i18n.__('旋转点')}\n        </div>\n
                    <div class="hiprint-option-item-field">\n       
                     <select class="auto-submit">\n      
                       <option value="" >${i18n.__('默认')}</option>    \n        
                       <option value="top left" >${i18n.__('左上角')}</option>\n         
                       <option value="center" >${i18n.__('中心')}</option>\n       
                      </select>\n       
                    </div>\n    
            </div>`), this.target;
      }, t.prototype.getValue = function () {
    ...
    function o(i) {
      ...
      if (!(i.ctrlKey || i.metaKey) && (i.data.target.className.startsWith('resize-panel') || "2" == i.data.target.style.zIndex || i.data.target.className.startsWith('hiprint-printElement'))) {
        ...
        if (o.options.designTarget && o.options.designTarget.options.transform) {
          ...
          // ########当有旋转角度的时候,解除页面拖拽限制######
        // 左右 
        if(!(data.target && data.target.style.transform && getBracketContent(data.target.style.transform))){
    ...
    t.fn.hidraggable = function (e, n) {
      return "string" == typeof e ? t.fn.hidraggable.methods[e](this, n) : this.each(function () {
        ...
        t.data(this, "hidraggable", {
          ...
          if(getBracketContent(e?.currentTarget?.style?.transform) && e.currentTarget?.style?.transformOrigin !== 'center'){
            if (0 != s(e)) {
              t(this).css("cursor", "");
              ...
              if (tr) {
                p.startTop = p.target.offsetTop;
                p.startLeft = p.target.offsetLeft;
              }
              t.extend(e.data, p);
       ...
       e.prototype.getBarAutoWidth = function () {
        ...
        try {
          ...
          if(!this.options.letterSpacing){
            this.options.letterSpacing = 4;
          }
          if(!this.options.fontSize){
            this.options.fontSize = 8;
          }
          if(!this.options.fontFamily){
            this.options.fontFamily = '黑体'
          }
          let includetext = this.options.barcodeType  && this.options.barcodeType.toLowerCase().includes('ean')  ? true : false; 
          ...
          const barWidth = includetext? this.options.barWidth || 2 :this.options.barWidth || 1;
          ...
          if(!includetext){
            ...
            content.html($('<svg width="100%" display="block" height="100%" class="hiprint-printElement-barcode-svg" preserveAspectRatio="none slice"></svg>'));
            // console.log('height',  height ,this.options.fontSize,this.options );
            const renderSvgElment = content.find('.hiprint-printElement-barcode-svg');
            JsBarcode(renderSvgElment[0], text || this.options.testData || 'testData', {
              text: text || this.options.testData || this.options.title,
              format: this.options.barcodeType,
              textMargin: 0,
              lineColor: this.options.color || "",
              margin: 0,
              width:2,
              fontSize:this.options.fontSize,
              font:this.options.fontFamily || '黑体',
              fontOptions:this.options.fontWeight || '',
              height: 30,
              displayValue: includetext ? true : !this.getHideTitle() ,
            });
            renderSvgElment.attr("height", "100%");
            renderSvgElment.attr("width", "100%");
            const firstSVGCode = $('.hiprint-printElement-barcode-svg').find('g')?.[0];
            if(firstSVGCode){
              $(firstSVGCode).attr('transform','translate(10, 0)');
            }
            // pub-beta 0.0.57-beta22 解决条形码自动宽度问题
            let svgWidth = renderSvgElment.attr("width");
            svgWidth = Math.ceil(hinnn.px.toPt(svgWidth * 1.05));
            if (this.getBarAutoWidth() && svgWidth > this.options.width) {
              renderSvgElment.parent().css("width", svgWidth + 'pt')
              this.options.width = svgWidth;
            }
          }
        } catch (error) {
    ...
    pt = function () {
      ...
      t.prototype.bindBatchMoveElement = function () {
        ...
        this.designPaper.getTarget().on("mousemove", function (e) {
          ...
          s.a.instance.draging || (t.mouseRect && t.mouseRect.target && 
